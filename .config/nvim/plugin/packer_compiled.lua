...
_G.packer_plugins = {
  ...
  ["cmp-copilot"] = {
    loaded = true,
    path = "/home/f0dy/.local/share/nvim/site/pack/packer/start/cmp-copilot",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/f0dy/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["markdown-preview.nvim"] = {
    loaded = true,
    path = "/home/f0dy/.local/share/nvim/site/pack/packer/start/markdown-preview.nvim",
