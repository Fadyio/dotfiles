...
_G.packer_plugins = {
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/home/f0dy/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/f0dy/.local/share/nvim/site/pack/packer/start/nlsp-settings.nvim",
  ...
  ["toggleterm.nvim"] = {
    loaded = true,
    path = "/home/f0dy/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
    url = "https://github.com/akinsho/toggleterm.nvim"
  },
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/f0dy/.local/share/nvim/site/pack/packer/start/vim-bbye",
