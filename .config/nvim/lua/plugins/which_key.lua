...
if is_plugin_installed("packer.nvim") then
  which_key.register({
    p = {
      name = "Packer",
      i = { ":PackerInstall<CR>", "Install FADYVIM packages" },
      u = { ":PackerUpdate<CR>", "Update FADYVIM packages" },
      r = { ":PackerClean<CR>", "Uninstall unnecessary FADYVIM packages" },
      s = { ":PackerSync<CR>", "Sync FADYVIM packages" },
      c = { ":PackerCompile<CR>", "Compile FADYVIM packages" },
    },
  }, { prefix = "<leader>" })
end
