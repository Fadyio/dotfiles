...
-- Defining FADYVIMUpdate commands.
vim.api.nvim_create_user_command("FADYVIMUpdate", function()
  require("utils").update()
end, { nargs = 0 })

-- Creating FADYVIMTransparent command.
vim.api.nvim_create_user_command("FADYVIMTransparent", "lua make_FADYVIM_transparent()", { nargs = 0 })
