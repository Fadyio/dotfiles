...
return require("packer").startup({
  function()
    ...
    -- These two plugins make startup faster.
    ...
    -- This plugin is needed for many plugins(like telescope)
    use({
    ...
    use({
      ...
      disable = disable_plugins.nvim_github,
    })
  use({
      "mhartington/oceanic-next",
      disable = disable_plugins.OceanicNext,
    })
